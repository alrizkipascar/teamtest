        ...
        <div v-if="userPermissions.canAddTeamMembers">
            ...
            <jet-form-section @submitted="addTeamMember">
                ...
                <template #form>
                    ...
                    <!-- <div class="col-span-6 sm:col-span-4">
                        <jet-label for="roles" value="Email" />
                        <select name="email" id="email" class="form-control" v-model="addTeamMemberForm.email">
                        <option v-for="user in $page.props.users" :key="user.users" >{{ displayableUser(user.email)  }}</option>
                        </select>
                    </div> -->
...
<script>
    ...
    export default defineComponent({
        ...
        // displayableUser(user) {
        //         return this.user.find(r => r.key === user).email
        //     },
